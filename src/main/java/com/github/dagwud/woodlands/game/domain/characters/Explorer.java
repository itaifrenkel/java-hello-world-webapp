...
import com.github.dagwud.woodlands.game.domain.characters.spells.AlmanacOfZoology;
...
public class Explorer extends PlayerCharacter
{
  ...
  Explorer(Player playedBy)
  {
    ...
    getSpellAbilities().register(new SpiritOfAdventure(this)); // passive
    getSpellAbilities().register(new AlmanacOfZoology(this)); // active
  }
}
