...
public class TavernMenu extends GameMenu
{
  public TavernMenu()
  {
    String message Aaron The smell of spilled beer permeates the local tavern, and the floor crunches slightly underfoot as you walk across the dirt from dozens of well-worn shoes.\n" +
    "\n" +
