...
import com.github.dagwud.woodlands.game.commands.locations.mountain.GeneratePettingZooEncounterCmd;
...
public class EnterThePettingZooCmd extends AbstractCmd
{
  ...
  public EnterThePettingZooCmd(PlayerState playerState)
  {
  ...
  public void execute()
  {
    ...
    RunLaterCmd cmd = new RunLaterCmd(Settings.DELAY_BETWEEN_ENCOUNTERS_MS,
            new GeneratePettingZooEncounterCmd(playerState));
