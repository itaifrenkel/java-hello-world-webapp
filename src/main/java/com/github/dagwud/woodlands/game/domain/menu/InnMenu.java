...
public class InnMenu extends GameMenu
{
  ...
  public InnMenu()
  {
    ...
    setOptions(ECommand.SHORT_REST, ECommand.LONG_REST, ECommand.VILLAGE_SQUARE, ECommand.RETRIEVE_ITEMS, ECommand.LEAVE_ITEMS, ECommand.SWITCH_CHARACTERS, ECommand.CHANGE_NAME);
  }
}
